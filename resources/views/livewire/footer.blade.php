 <footer class="section-footer">
     <div class="relative z-10 overflow-hidden bg-colorGreyDark">
         <div class="section-space-top">
             <div class="container">
                 <div class="mx-auto flex max-w-[989px] flex-wrap items-center justify-between gap-10">
                     ...
                     <a href="contact.html"
                         class="mx-auto inline-flex h-[110px] w-[110px] items-center justify-center rounded-[50%] border border-colorOrange text-colorOrange hover:scale-110 hover:bg-colorOrange hover:text-white xl:h-[126px] xl:w-[126px]">
                         Contact Us
                     </a>
                 </div>
             </div>
             ...
             <div class="container">
                 <div class="flex flex-wrap items-center justify-center gap-10 lg:justify-between">
                     <div class="flex flex-wrap items-center justify-center gap-10 lg:justify-start xl:gap-[94px]">
                         <a href="index.html">
                             <img src="assets/img/logo-white.png" alt="logo-white" width="118" height="25"
                                 class="h-auto w-[118px]" />
                         </a>

                         <form action="#" method="post" class="relative w-full sm:w-[424px]">
                             <input type="text" name="email" id="emai" placeholder="Your Email"
                     ...
                     <div class="flex gap-[14px]">
                         <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer"
                             ...
                             <img src="assets/img/icon/icon-white-facebook.svg" alt="icon-white-facebook" width="24"
                                 height="24" class="h-auto w-6" />
                         </a>
                         <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer"
                             aria-label="instagram"
                             class="inline-flex h-14 w-14 items-center justify-center rounded-[50%] border border-white/[8%] bg-white/5 hover:bg-colorOrange">
                             <img src="assets/img/icon/icon-white-instagram-fill.svg" alt="icon-white-instagram-fill"
                                 width="24" height="24" class="h-auto w-6" />
                         </a>
                         <a href="https://www.x.com/" target="_blank" rel="noopener noreferrer" aria-label="x"
                             class="inline-flex h-14 w-14 items-center justify-center rounded-[50%] border border-white/[8%] bg-white/5 hover:bg-colorOrange">
                             <img src="assets/img/icon/icon-white-x-fill.svg" alt="icon-white-x-fill" width="24"
                                 height="24" class="h-auto w-6" />
                         </a>
                     </div>
                 </div>
         ...
         <div class="">
             <div class="container">
                 <ul
                     ...
                     <li>
                         <a href="index.html" class="hover:text-colorOrange">HOME</a>
                     </li>
                     <li>
                         <a href="about.html" class="hover:text-colorOrange">RESOURCES</a>
                     </li>
                     <li>
                         <a href="project.html" class="hover:text-colorOrange">ABOUT US</a>
                     </li>
                     <li>
                         <a href="team.html" class="hover:text-colorOrange">GET INVOLVED</a>
                     </li>
                     <li>
                         <a href="service.html" class="hover:text-colorOrange">FAQ</a>
                     </li>
                     <li>
                         <a href="contact.html" class="hover:text-colorOrange">CONTACT US</a>
                     </li>
                     <li>
                         <a href="faq.html" class="hover:text-colorOrange">CAREER</a>
                     </li>
                     <li>
                         <a href="blog.html" class="hover:text-colorOrange">OUR BLOG</a>
                     </li>
                 </ul>
                 <div class="py-[35px]">
                     <p class="text-center">
         ...
         <img src="assets/img/images/th-1/footer-bg.png" alt="team-bg" width="590" height="320"
