...
<section class="section-pricing">
    <div class="section-space-bottom">
        <div class="container">
            <div class="grid grid-cols-1 gap-20 lg:grid-cols-[minmax(0,_0.4fr),_1fr] xxl:grid-cols-[minmax(0,_0.9fr),_1fr] xxl:gap-[121px]">
                <div class="jos order-2 lg:order-1" data-jos_animation="fade">
                    <img src="assets/img/images/th-1/pricing-image.png" alt="pricing-image" width="474" height="474" class="ml-auto hidden h-auto w-auto xxl:block" />
                </div>
                <div class="order-1 lg:order-2">
                    ...
                    <ul class="mt-14 grid grid-cols-1 md:grid-cols-2">
                        <li class="jos bg-colorGreyDark px-14 py-8">
                            <img src="assets/img/icon/icon-orange-3d-modeling.svg" alt="icon-orange-3d-modeling" width="68" height="68" />
                            <h3 class="mb-6 mt-6 font-bold">Pray</h3>

                            <ul class="mb-10 flex list-inside list-image-[url(../img/icon/icon-white-check-mark.svg)] flex-col gap-y-5">
                                <p>
                        ...
                        <li class="jos bg-colorGreyDark px-14 py-8">
                            <img src="assets/img/icon/icon-orange-3d-modeling.svg" alt="icon-orange-3d-modeling" width="68" height="68" />
                            <h3 class="mb-6 mt-6 font-bold">New Convert Form</h3>
                           @livewire('soul-form')
                        </li>
                    </ul>
                </div>
