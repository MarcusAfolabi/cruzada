    ...
    <div class="section-space">
        <div class="container">
            <div class="">
                ...
                <ul class="rounded-xl jos grid h-[calc(100%-1px)] gap-x-24 overflow-hidden bg-colorGreyDark px-10 md:grid-cols-2 md:px-14">
                    <li class="jos border-b border-white/[12%] py-10 md:py-14" data-jos_delay="0">
                        ...
                        <br>
                        <a href="https://www.bible.com/reading-plans/19038-bible-in-a-year-365-day-reading-plan" target="_blank" class="btn group inline-flex items-center gap-x-3 border-b border-colorOrange pb-1 text-colorOrange">
                            DOWNLOAD CALENDAR
