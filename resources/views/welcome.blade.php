...
@section('main')
    <section class="section-hero">
        <div class="hero relative z-10">
            <div class="pb-20 pt-44 lg:pb-24 lg:pt-52 xl:pb-32 xl:pt-56 xxl:pb-[180px] xxl:pt-[270px]">
                <div class="container">
                    <div class="mx-auto flex max-w-[960px] flex-col items-center gap-y-12 text-center">
                        <h5 class="jos text-4xl font-extrabold text-orange-600 sm:text-6xl md:text-7xl lg:text-9xl xl:text-[150px]"
                            data-jos_delay="0.3">
                        ...
                        <div class="jos flex gap-x-[34px] font-extrabold text-xl text-orange-600">
                            <a href="#"> <span
            ...
            <img src="assets/img/images/th-2/3.png" alt="hero-bg-img-3" width="550" height="339"
            ...
            <img src="assets/img/images/th-2/4.png" alt="hero-bg-img-4" width="550" height="339"
            ...
            <img src="assets/img/images/th-2/6.png" alt="hero-bg-img-6" width="463" height="292"
