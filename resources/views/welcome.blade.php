...
<section class="section-hero">
    <div class="hero relative z-10">
        ...
        </div>  <img src="assets/img/images/th-2/3.png" alt="hero-bg-img-3" width="550" height="339" class="image-move absolute bottom-[77px] left-0 -z-10 w-[44%] rounded-[170px] lg:bottom-[106px] xl:bottom-auto xl:top-[610px] xl:w-auto" />
