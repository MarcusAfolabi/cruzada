...
<section class="section-hero">
    <div class="hero relative z-10">
        <div class="pb-20 pt-44 lg:pb-24 lg:pt-52 xl:pb-32 xl:pt-56 xxl:pb-[180px] xxl:pt-[270px]">
            <div class="container">
                <div class="mx-auto flex max-w-[960px] flex-col items-center gap-y-12 text-center">
                    ...
                    <div class="jos flex gap-x-[34px] font-extrabold text-xl text-colorDark">
                        <a href="#"> <span class="relative after:absolute after:left-[calc(100%+_17px)] after:top-1/2 after:h-[6px] after:w-[6px] after:-translate-y-1/2 after:rounded-[50%] after:bg-colorGreyLight last:after:hidden">GET
                                INVOLVED</span>
                        </a>
                    ...
                    <a data-fslightbox="gallery" href="https://www.youtube.com/watch?v=FqV_jROapXs" aria-label="video-play" class="animate-transition text-text mx-auto inline-flex h-24 w-24 items-center justify-center overflow-hidden rounded-[50%] bg-colorDark text-white hover:scale-110 hover:bg-colorDark/80 md:h-32 md:w-32">
                        <span class="absolute">Our Work</span>
                    </a>
                </div>
            </div>
        </div>
        <!-- <img src="assets/img/images/th-2/7.png" alt="hero-bg-img-1" width="384" height="292"
                class="image-move absolute left-10 top-[118px] -z-10 w-[40%] lg:w-[30%] xl:left-40 xl:w-auto xxl:left-[317px]" />
            <img src="assets/img/images/th-2/2.png" alt="hero-bg-img-2" width="176" height="204"
        ...
        <img src="assets/img/images/th-2/3.png" alt="hero-bg-img-3" width="550" height="339" class="image-move absolute bottom-[77px] left-0 -z-10 w-[44%] rounded-[170px] lg:bottom-[106px] xl:bottom-auto xl:top-[610px] xl:w-auto" />
        <img src="assets/img/images/th-2/4.png" alt="hero-bg-img-4" width="550" height="339" class="image-move absolute right-0 top-[118px] -z-10 w-[44%] rounded-[170px] xl:w-auto" />
        <!-- <img src="assets/img/images/th-2/5.png" alt="hero-bg-img-5" width="179" height="204"
        ...
        <img src="assets/img/images/th-2/6.png" alt="hero-bg-img-6" width="463" height="292" class="image-move absolute bottom-20 right-10 -z-20 w-[40%] md:bottom-auto md:top-[512px] lg:top-[600px] xl:right-20 xl:top-[657px] xl:w-auto xxl:right-[257px]" />
    </div>
</section>
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-10">
                        ...
                        <div class="flex w-full flex-col justify-between gap-x-28 xxl:flex-row">
                            <div class="jos flex" data-jos_animation="fade-right">
                                <img src="assets/img/images/th-1/about-img-2.jpg" alt="about-img-2" width="648" height="465" class="h-auto w-full" />
                            </div>
                            ...
                            <div class="flex flex-col justify-between gap-y-10 py-[50px]">
                                ...
                                <div class="jos justify-items-end" data-jos_delay="0.6">
                                    <a href="#" class="btn group ml-auto inline-flex items-center gap-x-3 border-b border-colorOrange pb-1 text-colorOrange">
                                        Pictorial Moment
...
<section class="why-us-section">
    <div class="section-space-bottom">
        <div class="container">
            <div class="relative">
                <ul class="jos bottom-10 right-0 mt-10 flex flex-col gap-[52px] bg-colorGreyWhite p-10 md:mt-0 md:flex-row md:p-[60px] xxl:absolute xxl:max-w-[975px]">
                    <li>
                        <img src="assets/img/icon/service-card-icon-1.svg" alt="service-card-icon-1" width="68" height="68" />
                        ...
                        <p class="text-colorGreyLight">
                            ...
                            <a href='#' class="flex w-full flex-1 items-center justify-between gap-x-5 font-title text-xl font-bold leading-[1.375] text-colorDark hover:text-colorOrange lg:text-[22px]">Give
                                Now</a>
                        </p>
                    </li>
                    <li>
                        <img src="assets/img/icon/service-card-icon-2.svg" alt="service-card-icon-2" width="68" height="68" />
                        <h3 class="mb-6 mt-8 font-bold text-colorDark">
                            SHARE THE BIBLE </h3>
                        <p class="text-colorGreyLight">
                            ...
                            <a href='#' class="flex w-full flex-1 items-center justify-between gap-x-5 font-title text-xl font-bold leading-[1.375] text-colorDark hover:text-colorOrange lg:text-[22px]">Join
                                Now</a>
                        </p>
                    </li>
                </ul>
